    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-[#0e1626] border border-slate-800 w-full max-w-lg rounded-2xl shadow-2xl p-6 space-y-5 animate-in fade-in zoom-in-95">
        <div className="flex items-center justify-between border-b border-slate-800 pb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Plan consultation, scoping call, or training kickoff.</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          ...
          {/* Associate Lead */}
          <div>
            <label className="block font-semibold text-slate-300 mb-1">Client / Lead</label>
            <select
              value={leadId}
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="block font-semibold text-slate-300 mb-1">Meeting URL</label>
              <input
                type="url"
                value={meetUrl}
          ...
          {/* Agenda / Prep notes */}
          <div>
            <label className="block font-semibold text-slate-300 mb-1">Pre-meeting Agenda / Notes</label>
            <textarea
              rows={2}
              value={rawNotes}
