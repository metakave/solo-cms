...
export const DashboardHeader: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 bg-[#0c121e]/90 backdrop-blur-md border-b border-slate-800/80 px-6 py-3.5 transition-all">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
        {/* Brand & Tagline */}
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-indigo-600 via-violet-600 to-emerald-400 flex items-center justify-center shadow-lg shadow-indigo-500/20 text-white font-bold text-lg">
            S
          </div>
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-xl font-bold tracking-tight text-white flex items-center gap-2">
                Solo<span className="text-emerald-400 font-extrabold">CRM</span>
              </h1>
        ...
        <div className="flex-1 max-w-md relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-slate-900/80 text-sm text-slate-200 placeholder-slate-500 rounded-xl border border-slate-700/60 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all"
          />
        </div>
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 text-xs font-medium text-purple-300 bg-purple-950/40 hover:bg-purple-900/50 border border-purple-800/50 rounded-xl transition-all shadow-sm"
          ...
          <button
            ...
            className="p-2 text-slate-400 hover:text-slate-200 bg-slate-800/60 hover:bg-slate-800 border border-slate-700/60 rounded-xl transition-all"
      ...
      <div className="max-w-7xl mx-auto mt-3 pt-3 border-t border-slate-800/50 flex flex-wrap items-center justify-between gap-3 text-xs">
        {/* View Switcher */}
        ...
        <div className="flex items-center gap-1.5">
          <span className="text-slate-500 font-medium mr-1">Stream:</span>
          {[
            ...
            return (
              <button
                ...
                className={`px-2.5 py-1 rounded-lg transition-all font-medium flex items-center gap-1.5 ${
                  isSelected
                    ? 'bg-slate-700/80 text-emerald-300 border border-emerald-500/40'
                    : 'text-slate-400 hover:text-slate-200 hover:bg-slate-800/50'
                }`}
              >
                {item.icon && <item.icon className="w-3 h-3 text-emerald-400" />}
