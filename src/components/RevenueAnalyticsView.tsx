    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-900/80 border border-slate-800 p-5 rounded-2xl shadow-lg">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-base font-bold text-white">Revenue & Cashflow Analytics</h2>
        </div>
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-5 shadow-lg space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="text-sm font-bold text-slate-100">Odoo Consulting</h3>
                <div className="text-[11px] text-slate-400">Implementations & Customization</div>
              </div>
            </div>
          ...
          <div className="pt-2 border-t border-slate-800/80 space-y-2 text-xs">
            ...
            <div className="flex justify-between">
              <span className="text-slate-400">Realized Cash:</span>
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-5 shadow-lg space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="text-sm font-bold text-slate-100">Training Batches</h3>
                <div className="text-[11px] text-slate-400">Corporate Bootcamps & Workshops</div>
              </div>
            </div>
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-5 shadow-lg space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="text-sm font-bold text-slate-100">Advisory Retainers</h3>
                <div className="text-[11px] text-slate-400">Fractional CTO & Architecture</div>
              </div>
            </div>
            <span className="text-xs font-bold px-2 py-0.5 rounded-full bg-violet-500/10 text-violet-300 border border-violet-500/20">
              ...
              <tbody className="divide-y divide-slate-800/60">
                {allMilestones.map((m) => (
                  <tr key={m.id} className="hover:bg-slate-800/40 transition-colors">
                    <td className="py-3 px-4 font-bold text-slate-200">{m.clientName}</td>
                    <td className="py-3 px-4 text-slate-300">{m.title}</td>
                    ...
                    <td className="py-3 px-4 text-slate-400">{m.invoiceNumber || '—'}</td>
