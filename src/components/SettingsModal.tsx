      ...
      <div className="bg-white dark:bg-[#0e1626] border border-slate-200 dark:border-slate-800 w-full max-w-lg rounded-2xl shadow-2xl p-6 space-y-5 animate-in fade-in zoom-in-95 transition-colors">
        <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold text-slate-900 dark:text-white">SoloCRM Integrations & Settings</h2>
              <p className="text-xs text-slate-500 dark:text-slate-400">Configure your DeepSeek AI, Zoho Calendar, and Hermes credentials.</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSave} className="space-y-4 text-xs">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <a
                ...
                className="text-indigo-600 dark:text-indigo-400 hover:underline inline-flex items-center gap-1 text-[11px] font-medium"
              >
                <span>Get Key</span>
            ...
            <input
              ...
              placeholder="sk-..."
              className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-200 font-mono focus:outline-none focus:border-indigo-500"
            />
          ...
          <div className="space-y-1.5 pt-2 border-t border-slate-200 dark:border-slate-800">
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-200 focus:outline-none focus:border-emerald-500"
            />
            <p className="text-[11px] text-slate-500 dark:text-slate-400">
          ...
          <div className="space-y-1.5 pt-2 border-t border-slate-200 dark:border-slate-800">
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-200 font-mono focus:outline-none focus:border-purple-500"
              required
            />
            <p className="text-[11px] text-slate-500 dark:text-slate-400">
          ...
          <div className="pt-3 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
            {saveSuccess ? (
              ...
              <span className="text-slate-500 dark:text-slate-400 text-[11px]">Settings stored securely</span>
            )}
